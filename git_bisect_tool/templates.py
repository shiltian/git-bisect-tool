"""Test script templates for git bisect."""
...
#   pip install -e .
#
# If build fails and you want to skip this commit:
#   exit 125
# =============================================================================
...
#
# The test should:
#   - Return 0 (exit successfully) if the commit is GOOD
#   - Return 1-124 or 126-127 if the commit is BAD
#   - Return 125 if the commit cannot be tested (skip)
#
# Example: Run a specific test
#   ./run_test.sh my_test
#
# Example: Check if a binary produces expected output
#   output=$(./my_program --input test.txt)
...
#   fi
#
# Example: Run and check for crash
#   if ./my_program --test; then
#       exit 0  # Good - no crash
#   else
#       exit 1  # Bad - crashed
#   fi
# =============================================================================
...
# =============================================================================
# If we reach here without errors, the commit is good
# =============================================================================
echo "Test passed!"
exit 0
'''
...
# LLVM-specific test script template
LLVM_TEMPLATE = '''#!/bin/bash
# =============================================================================
...
def generate_template(output_path: str, template_name: str = 'generic') -> bool:
    """Generate a test script template.

    Args:
        output_path: Path to write the template.
        template_name: Name of template to use ('generic' or 'llvm').

    Returns:
        True if successful, False otherwise.
    """
    template = TEMPLATES.get(template_name, GENERIC_TEMPLATE)
...
def get_bundled_template_path(template_name: str) -> Path:
    ...
    return templates_dir / f'test-{template_name}.sh'
